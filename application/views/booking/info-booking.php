<div class="container">
    <center>
        <table>
            ...
            <tr>
                <td>
                    <a class="btn btn-sm btn-outline-danger" onclick="information('Waktu Pengambilan Buku 1x24 jam dari Booking!!!')" href="<?php echo base_url() . 'booking/exportToPdf/' . $this->session->userdata('id_user'); ?>"><span class="fas fa-file-pdf"></span> Pdf</a>
                </td>
            </tr>
        </table>
    </center>
